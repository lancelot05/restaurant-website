...
import { Breadcrumb, BreadcrumbItem, Button, Form, Input, Col, FormGroup, Label, FormFeedback } from 'reactstrap';
...
class Contact extends Component {
  ...
  handleSubmit(event){
    console.log("The current state : " + JSON.stringify(this.state));
    alert("The current state : " + JSON.stringify(this.state));
          ...
          <div className="col-12 col-md-9">
            <Form onSubmit={this.handleSubmit}>
              ...
              <FormGroup row>
                ...
                <Col md={10}>
                  <Input type="email" id="email" name="email" placeholder="Email" value={this.state.email} valid={errors.telnum === ''} invalid={errors.telnum !== ''} onChange={this.handleInputChange} onBlur={this.handleBlur('email')}/>
